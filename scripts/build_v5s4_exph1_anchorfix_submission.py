...
from scripts.build_v5s4_exph_macro_first_submission import build_source as build_h_source
from v5s.exph1_overlay import EXPH1_SOURCE

TARGET = "485"
SHELL = ROOT / "submission/a_test_message_bundle_v5s4_exph_macro_first_candidate.json"
OUT = ROOT / "submission/a_test_message_bundle_v5s4_exph1_anchorfix_candidate.json"


def build_source(cid, title, identifier):
    source = build_h_source(str(cid), title, identifier)
    if str(cid) == TARGET:
        source += EXPH1_SOURCE
